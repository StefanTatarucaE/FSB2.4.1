...
$policyDefinitionNameWindows = "vmss-enabledependencyagentwin-change-policy-def"
$policyDefinitionNameLinux = "vmss-enabledependencyagentlinux-change-policy-def"
