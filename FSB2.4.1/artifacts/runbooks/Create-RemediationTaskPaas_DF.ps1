<#
    .SYNOPSIS
        Create Remediation task for the resources that are not-compliant with the Datafactory Initiative

    .DESCRIPTION
        This runbook loops through all subscriptions in the Customer tenant and on each subscription, 
        loops through the policies that are not-compliant with the policy definition for the Datafactory Initiative, removes existing remediation task (if present)
...
$policyDefinitionName = "datafactory-change-policy"
