...
$policyDefinitionNameWindows = "vm-enabledependencyagentwin-change-policy-def"
$policyDefinitionNameLinux = "vm-enabledependencyagentlinux-change-policy-def"
