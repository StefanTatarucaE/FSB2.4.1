...
[Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSReviewUnusedParameter', 'ResourceGroupName', Justification = 'False positive as rule does not scan child scopes')]
[Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSReviewUnusedParameter', 'AutomationAccountName', Justification = 'False positive as rule does not scan child scopes')]
[Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSReviewUnusedParameter', 'SimultaneousModuleImportJobCount', Justification = 'False positive as rule does not scan child scopes')]
[Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSReviewUnusedParameter', 'AzureEnvironment', Justification = 'False positive as rule does not scan child scopes')]
[Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSReviewUnusedParameter', 'PsGalleryApiUrl', Justification = 'False positive as rule does not scan child scopes')]
...
function Login-AzureAutomation([bool] $AzModuleOnly) {
    try {
        ...
        if ($AzModuleOnly) {
            ...
            Select-AzSubscription -SubscriptionId $azContext.Subscription.id  | Write-Verbose
        } else {
            # old modules aer obsolete, not used anymore
        }
    } catch {
        throw $_.Exception
    }
