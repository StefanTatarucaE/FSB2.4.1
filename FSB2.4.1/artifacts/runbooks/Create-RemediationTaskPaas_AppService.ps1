<#
    .SYNOPSIS
        Create Remediation task for the resources that are not-compliant with the AppService Initiative

    .DESCRIPTION
        This runbook loops through in the Customer tenant and on each subscription,
        loops through the policies that are not-compliant with the policy definition for the appService Initiative, removes existing remediation task (if present)
...
$policyDefinitionName = "appservice-change-policy"
