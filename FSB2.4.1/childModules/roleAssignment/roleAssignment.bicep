...
DESCRIPTION: Deployment of Role assignments for existing managed identities for the Eviden Landingzones for Azure solution.
...
var builtInRoleNames = {
  ...
  'Backup Contributor':{
    id: subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '5e467623-bb1f-42f4-a55d-6e525e11384b')
  }
}
...
resource roleAssignment 'Microsoft.Authorization/roleAssignments@2020-10-01-preview' = [for roleDefinitionIdorName in roleDefinitionIdOrNames: {
  name: guid(subscription().subscriptionId, managedIdentityId, roleDefinitionIdorName)
  properties: {
