...
Describe 'Smoke and Sanity Testing for Eviden Landing Zones for Azure Solution' {
    ...
    Context 'Check Offline reporting for VM OS Management' {
        ...
        It 'Step19. Check if CSV VM_Availability report is created' {
        ...
        It 'Step19. Check if HTML VM_Availability report is created' {
        ...
        It 'Step19. Check if CSV VM_tag_patching report is created' {
        ...
        It 'Step19. Check if HTML VM_tag_patching report is created' {
