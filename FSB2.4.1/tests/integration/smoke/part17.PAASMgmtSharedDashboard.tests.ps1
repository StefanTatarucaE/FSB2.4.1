...
Describe 'Smoke and Sanity Testing for Eviden Landing Zones for Azure Solution' {
    ...
    Context 'Check shared dashboard PAASMGMT' {
        ...
        It 'Step01. Check if PaaSServicesReportingDashboard is created' {
        ...
        It 'Step55. Check if Getting started tile is created in shared dashboard' {
        ...
        It 'Step54. Check if product company logo is created in shared dashboard' {
        ...
        It 'Step56. Check if last version of Deployed PaaS services overview is created in shared dashboard' {
        ...
        It 'Step57. Check if SQL Database Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step57. Check if Data Factory Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step57. Check if Analysis Service Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step57. Check if App Service Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step57. Check if SQL Man. Instance Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step57. Check if Cosmos DB Report workbook is created and added to the shared dashboard' {
            $workBook = "Cosmos DB"
            $result = get-sharedDashboardReport -dashboardName $dashBoardName -workbookName $workbook -custMgmtSubscriptionId $custMgmtSubscriptionId -tenantId $tenantId -tagPrefix $tagPrefix -tagValuePrefix $tagValuePrefix
            $becauseText = ' Cosmos DB workbook should be created and added to shared dashboard ' + $($dashboardName) + ' Checked at: ' + $($dateTime)
            $result | Should -BeLike $true -Because $becauseText
        } 
        It 'Step57. Check if Cache for Redis Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step57. Check if Cache for Redis Ent. Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step57. Check if Application Gateway Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step57. Check if MySQL Server Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step57. Check if MySQL Flex. Server Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step57. Check if PostgreSQL Server Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step57. Check if PostgreSQL Flex. Svr Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step57. Check if MariaDB Report workbook is created and added to the shared dashboard' {
            $workBook = "MariaDB"
            $result = get-sharedDashboardReport -dashboardName $dashBoardName -workbookName $workbook -custMgmtSubscriptionId $custMgmtSubscriptionId -tenantId $tenantId -tagPrefix $tagPrefix -tagValuePrefix $tagValuePrefix
            $becauseText = ' MariaDB workbook should be created and added to shared dashboard ' + $($dashboardName) + ' Checked at: ' + $($dateTime)
            $result | Should -BeLike $true -Because $becauseText
        }
        It 'Step57. Check if Databricks Report workbook is created and added to the shared dashboard' {
            $workBook = "Databricks"
            $result = get-sharedDashboardReport -dashboardName $dashBoardName -workbookName $workbook -custMgmtSubscriptionId $custMgmtSubscriptionId -tenantId $tenantId -tagPrefix $tagPrefix -tagValuePrefix $tagValuePrefix
            $becauseText = ' Databricks workbook should be created and added to shared dashboard ' + $($dashboardName) + ' Checked at: ' + $($dateTime)
            $result | Should -BeLike $true -Because $becauseText
        }
        It 'Step57. Check if Synapse Analytics Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step57. Check if SQL Svr Stretch DB Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step57. Check if Dedicated SQL pools Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step57. Check if Cosmos DB for PostgreSQL clusters Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step57. Check if Data explorer cluster Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step57. Check if Container Registry Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step57. Check if Azure Kubernet Services Overview Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step57. Check if Azure Kubernet Services Workloads Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step57. Check if Azure Function Workloads Report workbook is created and added to the shared dashboard' {
