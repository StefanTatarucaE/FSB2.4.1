...
Describe 'Smoke and Sanity Testing for Eviden Landing Zones for Azure Solution' {
    ...
    Context ' Check shared dashboard Core' {
        ...
        It 'Step01. Check if CloudCoreReportingDashboard is created' {
        ...
        It 'Step03. Check if Getting started tile is created in shared dashboard' {
        ...
        It 'Step02. Check if product company logo is created in shared dashboard' {
        ...
        It 'Step04. Check if Tenant Users link is created in shared dashboard' {
        ...
        It 'Step04. Check if Tenant Groups link is created in shared dashboard' {
        ...
        It 'Step04. Check if Roles and Administrators link is created in shared dashboard' {
        ...
        It 'Step04. Check if App registrations link is created in shared dashboard' {
        ...
        It 'Step04. Check if Subscription Roles link is created in shared dashboard' {
        ...
        It 'Step10. Check if Incident and change Report link is created in shared dashboard' {
            $linkPrefix = "https://portal.azure.com/#blade/Microsoft_Azure_Storage/ContainerMenuBlade/overview/storageAccountId/"
        ...
        It 'Step24. Check if Azure Consumption Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step24. Check if PIM Role Assignments Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step12. Check if Pol. Assignments link is created in shared dashboard' {
        ...
        It 'Step12. Check if Pol. Compliance link is created in shared dashboard' {
        ...
        It 'Step24. Check if Security Log Except. Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step24. Check if Log Analytics Workspace Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step24. Check if Virtual WAN Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step24. Check if Orphan resources Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step24. Check if Maintenance Report workbook is created and added to the shared dashboard' {
        ...
        It 'Step15. Check if Cost Management link is created in shared dashboard' {
        ...
        It 'Step15. Check if Cost Advisor link is created in shared dashboard' {
