...
Describe 'CORE - Billing feature' {
    ...
    Context 'Verify billing function' {
        ...
        It 'Check if function run successfully' {
            ...
            $qOut = wait-loop -numberOfRetries 40 -sleepTime 30 -command get-functionAppLogsResult -params $params
            $qOut.Result | Should -Be 'Succeeded' `
                -Because $becauseText
        }
    }

    Context 'Verify CSV files' {
        ...
        It 'Check if all CSV files are generated' {
            $params = @{
