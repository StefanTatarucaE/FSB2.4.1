...
Describe 'Core - Shared dashboard CloudCoreReportingDashboard' {
    ...
    Context ' Check shared dashboard Core' {
        ...
        It ' Check if Tenant Users link is created in shared dashboard' {
        ...
        It ' Check if Tenant Groups link is created in shared dashboard' {
        ...
        It ' Check if Roles and Administrators link is created in shared dashboard' {
        ...
        It ' Check if App registrations link is created in shared dashboard' {
        ...
        It ' Check if Subscription Roles link is created in shared dashboard' {
        ...
        It ' Check if Incident and change Report link is created in shared dashboard' {
            $linkPrefix = "https://portal.azure.com/#blade/Microsoft_Azure_Storage/ContainerMenuBlade/overview/storageAccountId/"
        ...
        It ' Check if Azure Consumption Report workbook is created and added to the shared dashboard' {
        ...
        It ' Check if PIM Role Assignments Report workbook is created and added to the shared dashboard' {
        ...
        It ' Check if Pol. Assignments link is created in shared dashboard' {
        ...
        It ' Check if Pol. Compliance link is created in shared dashboard' {
        ...
        It ' Check if Security Log Except. Report workbook is created and added to the shared dashboard' {
        ...
        It ' Check if Log Analytics Workspace Report workbook is created and added to the shared dashboard' {
        ...
        It ' Check if Virtual WAN Report workbook is created and added to the shared dashboard' {
        ...
        It ' Check if Cost Management link is created in shared dashboard' {
        ...
        It ' Check if Cost Advisor link is created in shared dashboard' {
