...
Describe 'OS-MGMT - Shared dashboard VMOSManagementReportingDashboard' {
    ...
    Context ' Check shared dashboard OSMGMT' {
        ...
        It ' Check if VMOSManagementReportingDashboard is created' {
        ...
        It ' Check if Deploy VM UI link is created in shared dashboard' {
        ...
        It ' Check if Available Virtual Machines overview is created in shared dashboard' {
        ...
        It ' Check if Self Service Restore link is created in shared dashboard' {
        ...
        It ' Check if Backup Center link is created in shared dashboard' {
        ...
        It ' Check if Availability Report workbook is created and added to the shared dashboard' {
        ...
        It ' Check if Performance workbook is created in shared dashboard' {
        ...
        It ' Check if VM OS Image Gallery Report workbook is created and added to the shared dashboard' {
        ...
        It ' Check if Backup Report workbook is created and added to the shared dashboard' {
            $workbook = "Backup"
            $result = get-sharedDashboardReport -dashboardName $dashBoardName -workbookName $workbook -custMgmtSubscriptionId $custMgmtSubscriptionId -tenantId $tenantId -tagPrefix $tagPrefix -tagValuePrefix $tagValuePrefix
            $becauseText = ' Backup Report workbook should be created and added to shared dashboard ' + $($dashboardName) + ' Checked at: ' + $($dateTime)
            $result | Should -BeLike $true -Because $becauseText
        } 
        It ' Check if VM Tagging Report workbook is created and added to the shared dashboard' {
            $workbook = "VM Tagging"
            $result = get-sharedDashboardReport -dashboardName $dashBoardName -workbookName $workbook -custMgmtSubscriptionId $custMgmtSubscriptionId -tenantId $tenantId -tagPrefix $tagPrefix -tagValuePrefix $tagValuePrefix
            $becauseText = ' VM Tagging Report workbook should be created and added to shared dashboard ' + $($dashboardName) + ' Checked at: ' + $($dateTime)
            $result | Should -BeLike $true -Because $becauseText
        } 
        It ' Check if Antimalware Report workbook is created and added to the shared dashboard' {
        ...
        It ' Check if Availability Sets Report workbook is created and added to the shared dashboard' {
        ...
        It ' Check if Scale Sets Report workbook is created and added to the shared dashboard' {
            $workbook = "Scale Sets"
            $result = get-sharedDashboardReport -dashboardName $dashBoardName -workbookName $workbook -custMgmtSubscriptionId $custMgmtSubscriptionId -tenantId $tenantId -tagPrefix $tagPrefix -tagValuePrefix $tagValuePrefix
            $becauseText = ' Scale Sets Report workbook should be created and added to shared dashboard ' + $($dashboardName) + ' Checked at: ' + $($dateTime)
            $result | Should -BeLike $true -Because $becauseText
        } 
        It ' Check if Disk Encryption Report workbook is created and added to the shared dashboard' {
        ...
        It ' Check if Storage Accounts Report workbook is created and added to the shared dashboard' {
